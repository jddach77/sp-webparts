...
import * as strings from "MagpiePlaylistWebPartStrings";
import ReactSlideSwiper from "./components/MagpiePlaylist";
...
export default class ReactSlideSwiperWebPart extends BaseClientSideWebPart<
  IReactSlideSwiperWebPartProps
> {
  public render(): void {
    ...
    > = React.createElement(ReactSlideSwiper, {
