    ...
    return new Promise<Array<ListItem>>((resolve: any) => {
      const fakeData: Array<ListItem> = [
        ...
        },
        {
          ...
          imageUrl:
            "https://blog.velingeorgiev.com/static/images/POWERSHELL.png"
        },
        {
          title:
            "The market thinker strategically standardizes a competitive success",
          description:
        ...
        },
        {
          ...
          description:
            "The General Head of IT Strategy benchmarks business-for-business agilities",
          imageUrl:
            "https://blog.velingeorgiev.com/static/images/JAVASCRIPT.png"
        },
        {
          title: "The Digital Marketers empower a digitized correlation",
          description:
