...
- Upgrade Typescript to 2.7.2
- Upgrade to fabric 6
- Fixed the wrong theme being loaded when navigating cross app
- Avoid loading theme if navigating between apps
- Always reload theme when navigating between sites and apps
