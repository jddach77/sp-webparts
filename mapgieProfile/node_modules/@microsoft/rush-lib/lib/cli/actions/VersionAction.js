...
class VersionAction extends BaseRushAction_1.BaseRushAction {
    ...
    _validateResult() {
        ...
        const commonVersions = rushConfig.getCommonVersions(
        /* Always use the default variant */
        );
        const mismatchFinder = new VersionMismatchFinder_1.VersionMismatchFinder(rushConfig.projects, commonVersions.allowedAlternativeVersions);
