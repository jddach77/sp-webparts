...
class PublishAction extends BaseRushAction_1.BaseRushAction {
    ...
    _updateAPIFile(packageName, project) {
        ...
        if (node_core_library_1.FileSystem.exists(apiConfigPath)) {
            ...
            if (!!apiConfig['generateDtsRollup'] && !!apiConfig['dtsRollupTrimming']) {
                ...
                if (fromApiFolder) {
                    ...
                    if (node_core_library_1.FileSystem.exists(fromApiFolderPath) && node_core_library_1.FileSystem.exists(toApiFolderPath)) {
                        node_core_library_1.FileSystem.readFolder(fromApiFolderPath).forEach(fileName => {
