 ...
 */
export declare namespace RushConstants {
    /**
     ...
     */
    const browserApprovedPackagesFilename: string;
    /**
     * The folder name ("changes") where change files will be stored.
     */
    const changeFilesFolderName: string;
    /**
     ...
     */
    const pinnedVersionsFilename: string;
    /**
     ...
     */
    const commonVersionsFilename: string;
    /**
