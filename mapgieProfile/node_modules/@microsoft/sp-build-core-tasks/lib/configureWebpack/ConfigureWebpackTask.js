    ...
    executeTask(gulp, completeCallback) {
        ...
        const configAddons = {
            ...
            plugins: [
                ...
                // Built-in Webpack module that concatenates the scope of all modules
                // (aka scope hoisting) into one closure, which allows for faster code execution.
        ...
        const buildNumber = process.env.BUILD_BUILDNUMBER
            ? `'${process.env.BUILD_BUILDNUMBER.toLowerCase()}'`
            : '\'dev-0000-00-00.000\'';
