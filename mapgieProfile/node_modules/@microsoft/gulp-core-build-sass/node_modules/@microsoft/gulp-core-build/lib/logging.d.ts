 ...
 * @public
 */
export declare function log(...args: Array<string>): void;
/**
 ...
 * @public
 */
export declare function warn(...args: Array<string>): void;
/**
 * Logs an error to standard error and causes the build to fail.
 * @param message - the error description
 * @public
 */
export declare function error(...args: Array<string>): void;
/**
 ...
 * @public
 */
export declare function verbose(...args: Array<string>): void;
/** @public */
