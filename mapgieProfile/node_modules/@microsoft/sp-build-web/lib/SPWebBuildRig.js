...
class SPWebBuildRig extends sp_build_common_1.SPBuildRig {
    ...
    getTestTask() {
        return sp_build_common_1.serial(this.getBundleTask(), gulp_core_build_1.jest);
    }
    getCoreBuildTask() {
    ...
    getBundleTask() {
        return sp_build_common_1.serial(this.getBuildTask(), spBuildCoreTasks.collectLocalizedResources, this.getPreWebpackTasks(), spBuildCoreTasks.configureWebpack, gulp_core_build_webpack_1.default, // First webpack instance to create the base bundle
    ...
    getPreWebpackTasks() {
        return sp_build_common_1.serial();
    }
}
